The code and data in this library pertain to the task of grouping customers by service transformer using
AMI data.  Start with MeterToTransformerPairingScripts.py
